      ...
      <div className="w-96 space-y-6 overflow-y-auto">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-lg bg-[rgb(var(--quantum-500)/.1)] border border-[rgb(var(--quantum-500)/.2)] flex items-center justify-center">
              <Camera className="w-4 h-4 text-[rgb(var(--quantum-400))]" />
            </div>
            <div>
              <div className="text-sm font-medium text-white">Focus Vision IA</div>
              <div className="text-[11px] text-white/30">Monitoreo inteligente de concentración</div>
            </div>
          </div>
          <div className="px-3 py-2 rounded-lg bg-gradient-to-r from-[rgb(var(--quantum-500)/.08)] to-transparent border border-[rgb(var(--quantum-500)/.1)]">
            <p className="text-[11px] text-white/40 leading-relaxed">
              Monitoreo por cámara para detectar pérdida de concentración, ausencia y distracciones. Procesamiento 100% local.
            </p>
          </div>
          <div className="mt-3 flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-amber-400/60 animate-pulse" />
            <span className="text-[10px] text-amber-400/60 font-mono tracking-wider">PRÓXIMAMENTE</span>
          </div>
        </div>
